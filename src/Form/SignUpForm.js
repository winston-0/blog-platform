...
const SignUpForm = () => {
  ...
  const contextHolder = useErrorLogic(form)
    ...
    return (
        <React.Fragment>
          {contextHolder}
        <Form name="signUp" form={form} onFinish={onFinish} style={{width: 320}} layout='vertical' colon={false} requiredMark={false}>
            ...
            <Form.Item valuePropName='checked' name='agreement' rules={[
              {required: true}
            ]}>
            ...
            <Form.Item style={{marginBottom: 8}}>
              <Button type='primary' size='large' block htmlType='submit'>Create</Button>
            </Form.Item>
        </Form>
        </React.Fragment>
    )
