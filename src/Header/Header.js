...
const Header = () => {
    ...
    const unAuthoriseInterface = (
        <div className="header__unAuthorised">
            <Link to='/sign-in' className="header__signIn">Sign In</Link>
            <Link to='/sign-up' className="header__signUp">Sign Up</Link>
        </div>
    )
    const authorisedInterface = loggedIn ? (
        <div className="header__authorised">
            <Link to='/new-article' className="header__createArticle">Create article</Link>
            ...
            <a onClick={onLogOut} className="header__logOut">Log Out</a>
        </div>
    ) : null
    return (
        <header className="header">       
                <Link className="header__logo" to={'/'}>Realworld Blog</Link>
