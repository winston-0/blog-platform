...
import { registerUser } from "../blogApi/blogApi"
import { reloginUser } from "../blogApi/blogApi"
import { loginUser } from "../blogApi/blogApi"
import { updateUser } from "../blogApi/blogApi"
...
const profileSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder.addCase(requestToSignUp.fulfilled, (state, action) => {
            state.loggedIn = true
            state.loading = false
